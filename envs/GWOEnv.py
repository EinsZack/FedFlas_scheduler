...
class TaskAssignmentEnv:
    def __init__(self, ES_list, Client_list, model_type="cifar10", bandwidth=60):
        ...
        self.bandwidths_map = self.init_bandwiths(bandwidth)  # 读取当前Env下的这台Client到域内各个ES的带宽
        ...
        self.model_type = model_type  # 数据集类型
...
# renew time系列，配合计算time 使用，都需要删掉
    ...
    # 任务生成
    def init_bandwiths(self, bandwidth):
